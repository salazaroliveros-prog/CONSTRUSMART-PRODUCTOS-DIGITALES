        ...
        <div className="max-w-md w-full bg-white rounded-2xl shadow-2xl p-8 text-center">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6 text-left">
            ...
            <div className="flex items-start gap-2 mb-2">
              <AlertCircle className="w-5 h-5 text-blue-600 flex-shrink-0 mt-0.5" />
              <div className="text-sm text-blue-700">
                <strong>Paso 2:</strong> Envía comprobante a soporte@construsmart.gt con {orderIds.length > 1 ? 'tus números de orden' : 'tu número de orden'}
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-6 md:p-8">
              ...
              {!bankingInfo ? (
                <div className="bg-yellow-50 border border-yellow-200 text-yellow-800 p-4 rounded-lg">
                  ...
                  Los datos bancarios aún no han sido configurados. Contacta a soporte@construsmart.gt.
                </div>
              ) : (
